...
\addplot [pattern = dots] coordinates {(DUMMY,178) (RANDOM,72) (FIRE,179) (BETA,79)};
\addplot [pattern = north west lines] coordinates {(DUMMY,22) (RANDOM,128) (FIRE,21) (BETA,121)};
\legend{Right,Wrong}
\end{axis}
\end{tikzpicture}
...
\addplot [pattern = dots]  coordinates {(DUMMY,178) (RANDOM,74) (FIRE,184) (BETA,70)};
\addplot [pattern = north west lines] coordinates {(DUMMY,22) (RANDOM,126) (FIRE,16) (BETA,120)};
\legend{Right,Wrong}
\end{axis}
\end{tikzpicture}
...
\addplot [pattern = dots] coordinates {(DUMMY,119) (RANDOM,80) (FIRE,121) (BETA,86)};
\addplot [pattern = north west lines] coordinates {(DUMMY,81) (RANDOM,120) (FIRE,79) (BETA,114)};
\legend{Right,Wrong}
\end{axis}
\end{tikzpicture}
...
\addplot [pattern = dots] coordinates {(DUMMY,117) (RANDOM,91) (FIRE,117) (BETA,81)};
\addplot [pattern = north west lines] coordinates {(DUMMY,83) (RANDOM,109) (FIRE,83) (BETA,119)};
\legend{Right,Wrong}
\end{axis}
\end{tikzpicture}
...
\addplot [pattern = dots] coordinates {(DUMMY,167) (RANDOM,69) (FIRE,188) (BETA,48)};
\addplot [pattern = north west lines] coordinates {(DUMMY,33) (RANDOM,131) (FIRE,12) (BETA,152)};
\legend{Right,Wrong}
\end{axis}
\end{tikzpicture}
